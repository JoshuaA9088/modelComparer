...
ap.add_argument(
    "-t", "--input_txt", required=True, help="Input dir of TXT file of coordinates"
)

ap.add_argument(
    "-o", "--output_dir", required=True, help="Output dir of txt file of distances"
)
    ...
    with tf.Session(graph=detection_graph) as sess:
        for i in f.readlines():
            ...
            try:
                ...
                cvBoard = calculateDistance(
                    chassisBoard[0], chassisBoard[1], xCenterBoard, yCenterBoard
                )
            except:
                pass
            ...
            for c in range(len(xCDNN)):
                if c == 0:
                    dnnChassis = calculateDistance(
                        xCDNN[c], yCDNN[c], xCenterChassis, yCenterChassis
                    )
                elif c == 1:
                    dnnBoard = calculateDistance(
                        xCDNN[c], yCDNN[c], xCenterBoard, yCenterBoard
                    )
