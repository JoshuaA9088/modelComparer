...
ap.add_argument(
    "-m", "--model_path", required=False, help="Path to DNN model, defaults to 144k"
)

ap.add_argument("-o", "--output_dir", required=True, help="Output path of txt")
        ...
        for i in xmls:
            ...
            for j in range(len(file_list)):
                ...
                try:
                    ...
                    cv2.rectangle(
                        img, (xminDNN, ymaxDNN), (xmaxDNN, yminDNN), (255, 0, 0), 2
                    )
                    cv2.circle(
                        img, (xCenterDNN, yCenterDNN), centroid_radi, (255, 0, 0), -1
                    )
                except:
                    pass
                ...
                try:
                    cvDistance = calculateDistance(
                        chassisCentroid[0], chassisCentroid[1], xCenter, yCenter
                    )
                except:
                    cvDistance = None
